           ...
           <div class="container">
               <div class="newsletter-wrapper text-center">
                   <div class="newsletter-title">
                       ...
                       <p class="text-white">Enter Your Email Address To Get Alumni Association Newsletter!</p>
                   </div>
                   <form id="subscribe-form" class="form-inline" action="addemail.php" method="post">
                        <input type="text" class="form-control text-center form-text-light" id="email" name="email" value="" placeholder="E-mail Address">
                        <button type="submit" class="button bnt-theme" name="Submit" value="Submit">subscribe</button>
                    </form>
                    <div  id="success-message" style="display: none;">
                    <h2 class="heading-light" style="color:black;">Subscribed successfully!</h2>
                    </div>
               </div>
           </div>
        </div>
